import {
  classAdderBuilder
} from "./chunk-ESBO5UIV.js";
import {
  dist_default
} from "./chunk-US3UJD4Y.js";
import "./chunk-QIKJLB7N.js";
import "./chunk-ALM5KGUV.js";
import "./chunk-NE7DK4NL.js";
import {
  classMap,
  dispatch,
  forwardEventsBuilder,
  useActions
} from "./chunk-PTTEFC3P.js";
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      ...
      set_attributes(div, div_data = get_spread_update(div_levels, [
        (!current || dirty & /*className, multiple, withOpenDialog*/
        22 && div_class_value !== (div_class_value = classMap({
          [
            /*className*/
            ctx2[1]
          ]: true,
...
function create_fragment3(ctx) {
    ...
    ) },
    {
      class: classMap({
        ...
        ctx[0] ? (
          ...
          /*elevation*/
          ctx[4] !== 0 && /*variant*/
          ctx[2] === "raised" || /*extendedElevation*/
          ctx[8] !== 0 && /*variant*/
          ctx[2] === "raised" && /*extend*/
          ctx[7] && /*open*/
          ctx[0]
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      const paper_changes = dirty & /*usePass, className, open, opened, disabled, nonInteractive, variant, extend, extendedElevation, elevation, color, $$restProps*/
      69119 ? get_spread_update(paper_spread_levels, [
        dirty & /*usePass*/
        2048 && { use: (
          /*usePass*/
          ctx2[11]
        ) },
        dirty & /*className, open, opened, disabled, nonInteractive, variant, extend, extendedElevation, elevation*/
        1527 && {
          class: classMap({
            [
              /*className*/
            ...
            ctx2[0] ? (
              ...
              /*elevation*/
              ctx2[4] !== 0 && /*variant*/
              ctx2[2] === "raised" || /*extendedElevation*/
              ctx2[8] !== 0 && /*variant*/
              ctx2[2] === "raised" && /*extend*/
              ctx2[7] && /*open*/
              ctx2[0]
            )
          })
...
function instance3($$self, $$props, $$invalidate) {
  ...
  $$self.$$.update = () => {
    ...
    if ($$self.$$.dirty & /*previousOpen, open, accessor*/
    6291457) {
      $:
...
function create_fragment4(ctx) {
  ...
  let if_block1 = (
    /*$$slots*/
    ctx[20].description && create_if_block_1(ctx)
  );
  let if_block2 = (
    /*$$slots*/
    ctx[20].icon && create_if_block(ctx)
  );
  let div1_levels = [
    {
    ...
    { role: "button" },
    {
      tabindex: div1_tabindex_value = /*$nonInteractive*/
      ctx[7] ? -1 : 0
    },
    {
      "aria-expanded": div1_aria_expanded_value = /*$open*/
      ctx[9] ? "true" : "false"
    },
    /*$$restProps*/
    ctx[19]
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      ...
      1048576 && div0_class_value !== (div0_class_value = classMap({
        "smui-accordion__header__title": true,
        "smui-accordion__header__title--with-description": (
          /*$$slots*/
          ctx2[20].description
      ...
      set_attributes(div1, div_data_1 = get_spread_update(div1_levels, [
        ...
        34 && div1_class_value !== (div1_class_value = classMap({
          [
            /*className*/
            ctx2[1]
          ]: true,
        ...
        68 && div1_style_value !== (div1_style_value = Object.entries(
          /*internalStyles*/
          ctx2[6]
        ).map(func).concat([
          /*style*/
        ...
        { role: "button" },
        (!current || dirty & /*$nonInteractive*/
        128 && div1_tabindex_value !== (div1_tabindex_value = /*$nonInteractive*/
        ctx2[7] ? -1 : 0)) && { tabindex: div1_tabindex_value },
        (!current || dirty & /*$open*/
        512 && div1_aria_expanded_value !== (div1_aria_expanded_value = /*$open*/
        ctx2[9] ? "true" : "false")) && {
      ...
      if (Ripple_action && is_function(Ripple_action.update) && dirty & /*ripple, $nonInteractive, $disabled*/
      392)
